...
public class CompraVenta {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // TODO: Crear un bucle para lanzar los procesos jugadores (tantas veces como indique NUMERO_JUGADORES)
            // TODO: Cada proceso se lanzará con el comando: "cmd /c start cmd /K \"java Jugador.java ... ... \""
            // TODO: Para lanzar los procesos usamos el método Runtime.getRuntime.exec(...)
            // TODO: Imprime por consola un mensaje indicando que se ha creado el proceso jugador (y su número)
            for (int i = 0; i < NUMERO_JUGADORES; i++) {
                String orden = "cmd /c start cmd /K \"java Jugador.java " + (i + 1)+" "+nombreFichero+"\"";
                String[] comando = orden.split(" ");
                Runtime.getRuntime().exec(comando);
                System.out.println("CompraVenta: Creado el proceso del jugador: " + (i + 1));
            }
